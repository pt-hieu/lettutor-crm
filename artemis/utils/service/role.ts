...
export const updateRole = (data: {id: string; data: { name?: string; actionsId?: string[] }}) =>
  axios.patch(API + '/apollo/role/' + data.id, data.data).then((res) => res.data)
...
export const deleteRole = (data: {id: string}) =>
  axios.delete(API + '/apollo/role/' + data.id).then((res) => res.data)
